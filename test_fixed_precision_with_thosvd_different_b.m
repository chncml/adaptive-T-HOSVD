...
for k = 1 : length(tol)
    ...
    for sample = 1 : 10
        sample;
        t11 = tic;[G11, U11, mult_rank11] = adap_randomized_hosvd_EI_uniform(A, relerr, 10, 1);t11 = toc(t11);
        t12 = tic;[G12, U12, mult_rank12] = adap_randomized_hosvd_EI_uniform(A, relerr, 20, 1);t12 = toc(t12);
        t13 = tic;[G13, U13, mult_rank13] = adap_randomized_hosvd_EI_uniform(A, relerr, 30, 1);t13 = toc(t13);
        t14 = tic;[G14, U14, mult_rank14] = adap_randomized_hosvd_EI_uniform(A, relerr, 40, 1);t14 = toc(t14);
        t15 = tic;[G15, U15, mult_rank15] = adap_randomized_hosvd_EI_uniform(A, relerr, 50, 1);t15 = toc(t15);
        t16 = tic;[G16, U16, mult_rank16] = adap_randomized_hosvd_EI_uniform(A, relerr, 60, 1);t16 = toc(t16);
        t17 = tic;[G17, U17, mult_rank17] = adap_randomized_hosvd_EI_uniform(A, relerr, 70, 1);t17 = toc(t17);
        t18 = tic;[G18, U18, mult_rank18] = adap_randomized_hosvd_EI_uniform(A, relerr, 80, 1);t18 = toc(t18);
        t19 = tic;[G19, U19, mult_rank19] = adap_randomized_hosvd_EI_uniform(A, relerr, 90, 1);t19 = toc(t19);
        A11 = tmprod(G11, U11, [1, 2, 3]);Err11 = norm(A11(:) - A(:))/normA;ERR11(k, sample) = Err11;T11(k, sample) = t11;
        A12 = tmprod(G12, U12, [1, 2, 3]);Err12 = norm(A12(:) - A(:))/normA;ERR12(k, sample) = Err12;T12(k, sample) = t12;
        A13 = tmprod(G13, U13, [1, 2, 3]);Err13 = norm(A13(:) - A(:))/normA;ERR13(k, sample) = Err13;T13(k, sample) = t13;
        A14 = tmprod(G14, U14, [1, 2, 3]);Err14 = norm(A14(:) - A(:))/normA;ERR14(k, sample) = Err14;T14(k, sample) = t14;
...
for k = 1 : length(tol)
    ...
    for sample = 1 : 10
        sample;
        t11 = tic;[G11, U11, mult_rank11] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 10, 1);t11 = toc(t11);
        t12 = tic;[G12, U12, mult_rank12] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 20, 1);t12 = toc(t12);
        t13 = tic;[G13, U13, mult_rank13] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 30, 1);t13 = toc(t13);
        t14 = tic;[G14, U14, mult_rank14] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 40, 1);t14 = toc(t14);
        t15 = tic;[G15, U15, mult_rank15] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 50, 1);t15 = toc(t15);
        t16 = tic;[G16, U16, mult_rank16] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 60, 1);t16 = toc(t16);
        t17 = tic;[G17, U17, mult_rank17] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 70, 1);t17 = toc(t17);
        t18 = tic;[G18, U18, mult_rank18] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 80, 1);t18 = toc(t18);
        t19 = tic;[G19, U19, mult_rank19] = adap_randomized_hosvd_EI_kr_uniform(A, relerr, 90, 1);t19 = toc(t19);
        A11 = tmprod(G11, U11, [1, 2, 3]);Err11 = norm(A11(:) - A(:))/normA;ERR11(k, sample) = Err11;T11(k, sample) = t11;
        A12 = tmprod(G12, U12, [1, 2, 3]);Err12 = norm(A12(:) - A(:))/normA;ERR12(k, sample) = Err12;T12(k, sample) = t12;
        A13 = tmprod(G13, U13, [1, 2, 3]);Err13 = norm(A13(:) - A(:))/normA;ERR13(k, sample) = Err13;T13(k, sample) = t13;
        A14 = tmprod(G14, U14, [1, 2, 3]);Err14 = norm(A14(:) - A(:))/normA;ERR14(k, sample) = Err14;T14(k, sample) = t14;
