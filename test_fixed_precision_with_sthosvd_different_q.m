...
for k = 1 : length(tol)
    ...
    for sample = 1 : 10
        sample;
        t11 = tic;[G11, U11, mult_rank11] = adap_randomized_shosvd_EI_uniform(A, relerr, 60, 0);t11 = toc(t11);
        t12 = tic;[G12, U12, mult_rank12] = adap_randomized_shosvd_EI_uniform(A, relerr, 60, 1);t12 = toc(t12);
        t13 = tic;[G13, U13, mult_rank13] = adap_randomized_shosvd_EI_uniform(A, relerr, 60, 2);t13 = toc(t13);
        t14 = tic;[G14, U14, mult_rank14] = adap_randomized_shosvd_EI_uniform(A, relerr, 60, 3);t14 = toc(t14);
        t15 = tic;[G15, U15, mult_rank15] = adap_randomized_shosvd_EI_uniform(A, relerr, 60, 4);t15 = toc(t15);
        A11 = tmprod(G11, U11, [1, 2, 3]);Err11 = norm(A11(:) - A(:))/normA;ERR11(k, sample) = Err11;T11(k, sample) = t11;
        A12 = tmprod(G12, U12, [1, 2, 3]);Err12 = norm(A12(:) - A(:))/normA;ERR12(k, sample) = Err12;T12(k, sample) = t12;
        A13 = tmprod(G13, U13, [1, 2, 3]);Err13 = norm(A13(:) - A(:))/normA;ERR13(k, sample) = Err13;T13(k, sample) = t13;
        A14 = tmprod(G14, U14, [1, 2, 3]);Err14 = norm(A14(:) - A(:))/normA;ERR14(k, sample) = Err14;T14(k, sample) = t14;
...
for k = 1 : length(tol)
    ...
    for sample = 1 : 10
        sample;
        t11 = tic;[G11, U11, mult_rank11] = adap_randomized_shosvd_EI_kr_uniform(A, relerr, 60, 0);t11 = toc(t11);
        t12 = tic;[G12, U12, mult_rank12] = adap_randomized_shosvd_EI_kr_uniform(A, relerr, 60, 1);t12 = toc(t12);
        t13 = tic;[G13, U13, mult_rank13] = adap_randomized_shosvd_EI_kr_uniform(A, relerr, 60, 2);t13 = toc(t13);
        t14 = tic;[G14, U14, mult_rank14] = adap_randomized_shosvd_EI_kr_uniform(A, relerr, 60, 3);t14 = toc(t14);
        t15 = tic;[G15, U15, mult_rank15] = adap_randomized_shosvd_EI_kr_uniform(A, relerr, 60, 4);t15 = toc(t15);
        A11 = tmprod(G11, U11, [1, 2, 3]);Err11 = norm(A11(:) - A(:))/normA;ERR11(k, sample) = Err11;T11(k, sample) = t11;
        A12 = tmprod(G12, U12, [1, 2, 3]);Err12 = norm(A12(:) - A(:))/normA;ERR12(k, sample) = Err12;T12(k, sample) = t12;
        A13 = tmprod(G13, U13, [1, 2, 3]);Err13 = norm(A13(:) - A(:))/normA;ERR13(k, sample) = Err13;T13(k, sample) = t13;
        A14 = tmprod(G14, U14, [1, 2, 3]);Err14 = norm(A14(:) - A(:))/normA;ERR14(k, sample) = Err14;T14(k, sample) = t14;
